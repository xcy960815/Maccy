...
class AppDelegate: NSObject, NSApplicationDelegate {
  ...
  private func migrateUserDefaults() {
    ...
    if Defaults[.migrations]["2026-04-01-double-click-modifier"] != true {
      if UserDefaults.standard.object(forKey: "doubleClickOptionKey") != nil {
        Defaults[.doubleClickPopupEnabled] = UserDefaults.standard.bool(forKey: "doubleClickOptionKey")
        if Defaults[.doubleClickPopupEnabled] {
          Defaults[.doubleClickModifierKey] = .option
        }
        UserDefaults.standard.removeObject(forKey: "doubleClickOptionKey")
      }
