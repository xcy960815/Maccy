...
class About {
  ...
  private var links: NSMutableAttributedString {
    ...
    string.addAttribute(.link, value: "https://github.com/xcy960815/maccy", range: NSRange(location: 8, length: 6))
    string.addAttribute(.link, value: "https://github.com/xcy960815/maccy/issues", range: NSRange(location: 15, length: 7))
    return string
  }
