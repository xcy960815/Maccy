...
extension Defaults.Keys {
  ...
  static let doubleClickOptionKey = Key<Bool>("doubleClickOptionKey", default: false)
  static let doubleClickPopupEnabled = Key<Bool>("doubleClickPopupEnabled", default: false)
  static let doubleClickModifierKey = Key<DoubleClickModifierKey>("doubleClickModifierKey", default: .none)
